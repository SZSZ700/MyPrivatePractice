    ...
    public static void main (String[]args)throws Exception{
         ...
         */
            ...
            q.offer(() -> {
                ...
                f.setNext(g);
                g.setNext(h);
                Node<RangeNode> temp = tvachim(a);
                printListNod(temp);
                System.out.println();
                System.out.println("-------------------------------------------------------");
            });
            q.offer(() -> {
                System.out.println("פונקציה למציאת המרחק הקטן ביותר במחסנית בין 2 מופעים זהים של מספר");
                System.out.println("4 פונקציות עזר,ו 1 עיקרית, כאשר הקריאות לפונקציות והערכים המוחזרים נשמרים במחסנית הקריאות");
                Stack<Integer> stk = new Stack<>();//יצירת מחסנית,והזנת ערכים אלייה
                stk.push(1);
                stk.push(2);
                stk.push(3);
                stk.push(2);
                stk.push(7);
                stk.push(1);
                int x = miniDis(stk);//חישוב המרחק הקטן ביותר בין שני מופעים של מס
                System.out.println(stk);//הדפסת המחסנית
                System.out.println(x);//הדפסת המרחק הקטן ביותר
                System.out.println("-------------------------------------------------------");
            });
            q.offer(() -> {
                System.out.println("פונקציה רקורסיבית המקבלת שני מספרים ומחזירה כמה ספרות בשני המס זהים בערכן ומיקומן");
                int a = 678;
                int b = 679;
                int res = same(a, b);//קריאה לפונק לביצוע החישוב
            ...
            q.offer(() -> {
                System.out.println("פונקציה המסדרת שרשרת חוליות דו כיוונית כך שהמס הזוגיים בהתחלה ולאחריהם המס האי זוגיים");
                BinNode<Integer> a1 = new BinNode<>(1);
                BinNode<Integer> b1 = new BinNode<>(2);
                BinNode<Integer> c1 = new BinNode<>(3);
                BinNode<Integer> d1 = new BinNode<>(4);
                BinNode<Integer> e1 = new BinNode<>(5);
                a1.setRight(b1);
                b1.setLeft(a1);
                b1.setRight(c1);
                c1.setLeft(b1);
                ...
                reArrange_Dlist_Even_Odd(a1);
                printListBin(a1);
                System.out.println("-------------------------------------------------------");
            });
            q.offer(() -> {
                System.out.println("פונקציה למציאת המרחק הקטן ביותר במחסנית כלשהיא (בעץ) בין 2 מופעים זהים של מספר");
                Stack<Integer> stk1 = new Stack<>();//יצירת מחסנית,והזנת ערכים אלייה
                stk1.push(1);
                stk1.push(2);
                stk1.push(3);
                stk1.push(2);
                stk1.push(7);
                stk1.push(1);
                BinNode<Stack<Integer>> root = new BinNode<>(stk1);
                int r = lowMinStkInThree(root);//חישוב המרחק הקטן ביותר בין שני מופעים של מס
                System.out.println("המרחק הקטן ביותר במחסנית שבעץ בין שני מופעים של אותו מספר" + r);//הדפסת המרחק הקטן ביותר
                System.out.println("-------------------------------------------------------");
            });
            q.offer(() -> {
                System.out.println("פונקציה רקורסיבית ליצירת והחזרת מערך זוגיים, ממערך מקור");
            ...
            q.offer(() -> {
                System.out.println("פונקציה רקורסיבית המרת מס עשרוני לבינארי:");
                printToBin(12);
                System.out.println("-------------------------------------------------------");
            });
            q.offer(() -> {
                System.out.println("פונקציה המסדרת שרשרת חוליות חד כיוונית כך שהמס הזוגיים בהתחלה ולאחריהם המס האי זוגיים");
                Node<Integer> a = new Node<>(1);
            ...
            q.offer(() -> {
                System.out.println("פונקציה המקבלת שרשרת תווים ומסירה כפילויות");
                Node<Character> a = new Node<>('y');
                Node<Character> b = new Node<>('y');
                Node<Character> c = new Node<>('o');
                Node<Character> d = new Node<>('n');
                Node<Character> e = new Node<>('n');
                Node<Character> f = new Node<>('a');
                a.setNext(b);
                b.setNext(c);
                c.setNext(d);
                d.setNext(e);
            ...
            q.offer(() -> {
                System.out.println("מיון בועות זוגיים-אי זוגיים בשרשרת חוליות חד כיוונית");
                Node<Integer> a = new Node<>(1);
            ...
            q.offer(() -> {
                System.out.println("פונקציה היוצרת שרשרת פלינדרום");
                Node<Integer> a = new Node<>(1);
                Node<Integer> b = new Node<>(2);
                Node<Integer> c = new Node<>(4);
            ...
            q.offer(() -> {
                System.out.println("פונקציה הבודקת אם תור של מחסניות הוא תור מושלם");
                System.out.println("תור מושלם-מחסניותיו ממויינות בסדר עולה,איבר אחרון במחסנית נוכחית שווה לאיבר הראשון במחסנית הבאה בתור");
                System.out.println("והמחסניות בתור ממויינות בסדר עולה לפי אורכיהן(מהמחסנית הקצרה ביותר לארוכה ביותר)");
                ...
                stk3.push(7);
                stk3.push(6);
                Queue<Stack<Integer>> qo = new LinkedList<>();
                qo.offer(stk1);
                qo.offer(stk2);
                qo.offer(stk3);
                boolean result = PerfectQs(qo);
                System.out.println(result);
                System.out.println("-----------------------------------------------------------");

            });
            q.offer(() -> {
                System.out.println("פונקציה המחברת בין שלוש שרשראות כך שהארוכה יותר בהתחלה,והקצרה ביותר בסוף");
                Node<Integer> a = new Node<>(1, new Node<>(2, new Node<>(3, new Node<>(4))));
                Node<Integer> b = new Node<>(6, new Node<>(7));
                Node<Integer> c = new Node<>(10, new Node<>(11, new Node<>(12, new Node<>(13, new Node<>(14)))));
                Node<Integer> temp = bubbleLenS(a, b, c);
                printListNod(temp);
                System.out.println();
                System.out.println("-------------------------------------------------------");
            });
            q.offer(() -> {
                System.out.println("מחלקת דו מחסנית:");
                DoublyStack stack = new DoublyStack();
                stack.eraseNum(4);
                System.out.println(stack.getNumbers());
                System.out.println(stack.getSums());
                System.out.println("-------------------------------------------------------");
            });
            q.offer(() -> {
                ...
                tq.offer(4);
                tq.offer(5);
                Queue<Integer> res = doublevals(tq);
                System.out.println(res);
            });
            q.offer(() -> {
            ...
            q.offer(() -> {
                System.out.println("פונקציה לבדיקה אם סכום שני איברים בתור שווה לערך מסויים");
                ...
                qt.offer(4);
                qt.offer(5);
                System.out.println(twoSum(qt, 9));
            });
            q.offer(() -> {
                // יצירת עץ לדוגמה
                BinNode<Integer> root = new BinNode<>(10);
                BinNode<Integer> n1 = new BinNode<>(5);
                BinNode<Integer> n2 = new BinNode<>(15);
                BinNode<Integer> n3 = new BinNode<>(3);
                BinNode<Integer> n4 = new BinNode<>(7);
                BinNode<Integer> n5 = new BinNode<>(18);
                BinNode<Integer> n6 = new BinNode<>(100);
                root.setLeft(n1);   // 5 משמאל ל-10
                root.setRight(n2);  // 15 מימין ל-10
                n1.setLeft(n3);     // 3 משמאל ל-5
                n1.setRight(n4);    // 7 מימין ל-5
                n2.setRight(n5);    // 18 מימין ל-15
                n5.setRight(n6);    // 100 מימין ל-18

                // קריאה לפונקציה ובדיקת הרמה הגבוהה ביותר
                System.out.println("הרמה הגבוהה ביותר היא:");
                System.out.println(High(root));
                System.out.println("-------------------------------------------------------");
            });
            q.offer(() -> {
                Queue<Integer> t = tiln(5);
            ...
            q.offer(() -> {
                System.out.println("פונקצייה ראשונה: בונה מחסנית סכומים ממחסנית רגילה");
                Stack<Integer> nums = new Stack<>();
                nums.push(1);
                nums.push(2);
                nums.push(3);
                nums.push(4);
                Stack<Integer> sums = sumss(nums);
                System.out.println("nums stk: " + nums);
                System.out.println("sums stk: " + sums);
                System.out.println();
                System.out.println("פונקצייה שנייה: פונק הבודקת אם מחסנית אחת היא מחסנית המס והמחסנית השנייה היא מחסנית הסכומים שלה");
                System.out.println("perfect two stacks: " + goodDoublyStk(nums, sums) + "!");
                System.out.println("-------------------------------------------------------");
            });
            q.offer(() -> {
                System.out.println("שרשרת פלא-אורך אי זוגי,ערך ראשון שווה לערך אחרון,הערך המינימלי באמצע");
            ...
            q.offer(() -> {
                ...
                int a = 54;
                int b = 32;
                Node<Integer> chain = buildDownList(num, a, b);
                printListNod(chain);
                System.out.println();
                System.out.println("-------------------------------------------------------");
            });
            ...
            q.offer(() -> {
                System.out.print("פונקציה המקבלת מחסנית גנרית ומחזירה מערך אובייקטים המכיל את הערכים מהמחסנית הגנרית");
                System.out.println();
                Stack<Integer> stk = new Stack<>();
                stk.push(80);
                stk.push(70);
                stk.push(90);
                Object[] arr = stackToArray(stk);
                for (int i = 0; i < arr.length; i++) {
            ...
            q.offer(() -> {
                System.out.print("פונקציה המכפילה את התור כך שכל ערך יופיע K פעמים:");
                Queue<Integer> qq = new LinkedList<>();
                qq.offer(8);
                qq.offer(10);
                qq.offer(12);
                qq.offer(4);
                System.out.print("before: " + qq);
                System.out.println();
                one(qq, 2);
                System.out.print("after: " + qq);
                System.out.println();
                System.out.println("-------------------------------------------------------");
                System.out.println();
                System.out.print("פונקציה המעדכנת את התור כך שהתור המעודכן יכיל את תוכן התור לפני העדכון K פעמים");
                System.out.println();
                ...
                qp.offer(12);
                qp.offer(4);
                System.out.print("before: " + qp);
                System.out.println();
                int k = 3;
                two(qp, k);
                System.out.print("after: " + qp);
                System.out.println();
                System.out.println("-------------------------------------------------------");
            });
            q.offer(() -> {
                System.out.println("func to rotate matrix according to given angle!");
                System.out.println("before: ");
                int[][] mat = new int[][]{{1, 2, 3}, {4, 5, 6}, {7, 8, 9}};
                printM(mat);
                System.out.println("after: ");
                int[][] temp = rotate(mat, 90);
                printM(temp);
                System.out.println("-------------------------------------------------------");
            });
            q.offer(() -> {
                System.out.println("How CPU Works (exec one line of assembly code))!");
                CPU cpu = new CPU();
                cpu.loadInstruction(new Instruction("ADD", "R1", "R2", "R3")); // R1 = R2 + R3
                cpu.loadInstruction(new Instruction("MUL", "R2", "R1", "R3")); // R2 = R1 * R3
                cpu.loadInstruction(new Instruction("SUB", "R3", "R2", "R1")); // R3 = R2 - R1
                cpu.run();
                cpu.printRegisters();
                System.out.println("-------------------------------------------------------");
            });
            ...
            //overLoad method in son class not take part of polymorphisem
            q.offer(() -> {
                B b = new B(1);
                C c  = new C(1);
                D d = new D(1);
                ...
                System.out.println("the answer is : " + d1.equals(d)+ "!!!!!! {expected false}");
                System.out.println("----------------------------------------------------------");
            });
            //2022 summer a' - 1
            q.offer(() -> {
            ...
            q.offer(() -> {
                ...
                var j = new BinNode<>(3);
                g.setRight(j);
                System.out.println("where function test: -> -> " + where(bt, 16, 4));
                System.out.println("----------------------------------------------------------");
            });
            //recursion on list...
            q.offer(() -> {
